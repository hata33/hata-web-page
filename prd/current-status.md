...
### 🌐 语言切换器重复显示
- **问题**: 首页语言切换按钮在大屏幕和小屏幕上重复显示
- **严重程度**: 中等
- **状态**: ✅ 已修复 (2025-09-22)
- **修复文件**: `prd/bugs/resolved/bug-20250922-ui-language-switcher-duplicate.md`

### 📝 TypeScript隐式any类型错误
- **问题**: Concerts和Videos页面参数具有隐式any类型，影响类型安全
- **严重程度**: 高
- **状态**: ✅ 已修复 (2025-09-22)
- **修复文件**: `prd/bugs/resolved/bug-20250922-typescript-implicit-any.md`
