  ...
  ja: {
    ...
    home: {
      ...
      introduction: {
        ...
        description:
          "シンガーソングライターとして、心に響くメロディと詩で多くの人々を魅了しています。代表曲「ひまわりの約束」は、映画『STAND BY ME ドラえもん』の主題歌として大ヒットし、世代を超えて愛される楽曲となりました。",
        achievements: [
          {
            title: "代表作品",
    ...
    videos: {
      ...
      items: [
        ...
        },
        {
          ...
          year: "2012",
          views: "67万",
          thumbnail: "/videos/aoi-shiori.jpg",
        },
        {
          id: 4,
          title: "ダイアローグ",
        ...
        },
        {
          ...
          year: "2018",
          views: "78万",
          thumbnail: "/videos/kimi-no-tona.jpg",
        },
        {
          id: 6,
          title: "ひまわりの約束 (Live Ver.)",
          year: "2020",
          views: "34万",
          thumbnail: "/videos/himawari-live.jpg",
        },
      ],
    },
    concerts: {
      ...
      items: [
        {
          ...
          content:
            "待望のニューアルバムが3月15日に発売決定。全12曲収録の充実の内容です。",
        },
        {
          date: "2024-01-10",
          title: "全国ツアー2024開催決定",
          content:
            "3月から全国6都市を回るツアーを開催。チケットは1月20日より発売開始。",
        },
        {
          date: "2023-12-25",
          title: "年末特別配信ライブ",
          content:
            "12月31日に特別配信ライブを開催。ファンへの感謝を込めたスペシャルなステージ。",
        },
      ],
    },
    contact: {
  ...
  zh: {
    ...
    home: {
      ...
      introduction: {
        ...
        subtitle: "旋律与诗篇编织的故事",
        description:
          "作为创作歌手，以触动心灵的旋律和诗篇吸引了众多粉丝。代表作《向日葵的约定》作为电影《STAND BY ME 哆啦A梦》的主题曲大受欢迎，成为跨越世代的经典歌曲。",
        achievements: [
          {
            title: "代表作品",
    ...
    news: {
      ...
      items: [
        ...
        },
        {
          ...
          title: "2024全国巡演决定",
          content:
            "将于3月开始在全国6个城市举办巡演。门票将于1月20日开始发售。",
        },
        {
          date: "2023-12-25",
          title: "年末特别直播演出",
